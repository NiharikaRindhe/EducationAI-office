...
import { classBandContains, type SimDomain, type ClassBand, type ParamDef } from './contract.js'
...
/** Catalog lines injected into the curator prompt. Pass the book's own
 *  class to offer only templates whose classBand covers it — a Class 5
